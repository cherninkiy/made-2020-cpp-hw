...
private:
    ...
    using fixed_type = std::conditional<old_color == -1,
            std::integral_constant<ssize_t, color>,
...
private:
    ...
    using ToVertex = typename TypeAt<CurEdge::to, typename _Graph::Vertices>::type;
    ...
    using DfsColorized = typename std::conditional<to_color != -1, ToColorized,
